...
<body class="animate-fade-in">
            ...
            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center gap-3">
                <div>
                    <h1 class="h2 fw-bold mb-1 d-flex align-items-center gap-3">
                        ...
                        <div>
                            <span class="text-gradient">Client Management</span>
                ...
                <div class="d-flex flex-wrap gap-3">
                    ...
                    <a href="deleted-clients.php" class="btn btn-outline-warning d-flex align-items-center gap-2">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-outline-secondary d-flex align-items-center gap-2" type="button" data-bs-toggle="dropdown">
                            ...
                            <?php if ($is_super_admin): ?>
                            <span class="badge bg-gradient-primary">SUPER</span>
                            <?php endif; ?>
                        </button>
    ...
    $(document).ready(function() {
        ...
        $('#exportCSV').click(function() {
            // Simple CSV export
            let csv = [];
            const headers = ['Client Code', 'Client Name', 'Type', 'Category', 'Phone', 'Email', 'Status'];
            ...
            $('#clientsTable tbody tr').each(function() {
                ...
                if (cols.length > 1) {
                    const row = [
                        ...
                        $(cols[3]).text().trim(),
                        $(cols[4]).text().trim(),
                        $(cols[5]).find('div').text().trim(),
                        $(cols[5]).find('a').text().trim() || 'N/A',
                        $(cols[6]).text().trim()
                    ];
                    csv.push(row.join(','));
                }
